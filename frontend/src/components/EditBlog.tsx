    ...
    return (
      <div className="w-full min-h-screen flex items-center justify-center px-4 py-8">
        ...
        className="w-full max-w-md bg-white rounded-2xl  p-6">
          <h2 className="text-xl md:text-2xl text-center font-bold text-gray-800 mb-2">Update your writing !</h2>
          <h2 className="text-sm sm:text-base font-light text-center mb-5 tracking-tighter antialiased">Re-write your thoughts more expressively </h2>
